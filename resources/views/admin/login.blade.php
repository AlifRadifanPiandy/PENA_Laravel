...
@section('content')
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
        style="background-image: url(/ceres-html-pro/assets/media/illustrations/dozzy-1/14.png">
        <!--begin::Content-->
        ...
        <div class="d-flex flex-center flex-column-auto p-10">
            ...
            <div class="d-flex align-items-center fw-bold fs-6">
                Created by <a href="https://naufal.dev" class="text-muted text-hover-primary px-2"
                    target="_blank">naufal.dev</a>
            </div>
            <!--end::Links-->
        </div>
        <!--end::Footer-->
